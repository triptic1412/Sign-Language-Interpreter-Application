...
from recognize_gesture import pred_main
from Reverse_Recognition import rr_main

import resource, sys, threading
sys.setrecursionlimit(209715200)    # adjust numbers
    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label4 = Label(f2, text="                            Sign Language Recognition System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                statusbar = Label(f1, text="                            Sign Language Recognition System", font=("arial", 8, "bold"),
                ...
                label4 = Label(f3, text="                            Sign Language Recognition System", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                ...
                label11 = Label(f4, text="     Sign Language Recognition System", font=("arial", 10, "bold"), bg="grey16",
                                fg="white")
                ...
                def swap4(frame):
                    frame.tkraise()
                    statusbar['text'] = '                            Sign Language Recognition System'
