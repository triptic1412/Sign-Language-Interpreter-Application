...
def get_image_size():
	...
	img = img.astype('float')   #new line added
	return img.shape
...
def cnn_model_fn(features, labels, mode):
	...
	onehot_labels = tf.compat.v1.one_hot(indices=tf.compat.v1.cast(labels, tf.int32), depth=num_of_classes)
	loss = tf.compat.v1.layers.losses.softmax_cross_entropy(onehot_labels=onehot_labels, logits=logits)  #
